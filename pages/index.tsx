...
export default function Home() {
  ...
  // NEW: Store Global Network Averages
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (res.data.result && res.data.result.pods) {
        ...
        // --- Store Global Stats for Breakdown ---
  ...
  const renderHealthBreakdown = () => {
      ...
      const avgs = networkStats.avgBreakdown; // Get global averages
      ...
      return (
          <div className="animate-in fade-in slide-in-from-right-2 duration-200 h-full flex flex-col">
              ...
              <div className="flex-grow flex flex-col gap-6">
                  {/* SCORE CARD (LEFT SIDE in Original Design - Top here for mobile) */}
