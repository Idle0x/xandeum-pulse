                            ...
                            return (
                                <div className="space-y-4">
                                    <div className="flex justify-between items-end border-b border-white/5 pb-3">
                                        <div>
                                            <div className="text-[10px] text-zinc-500 uppercase">Your Score</div>
                                            <div className="text-3xl font-bold text-white">{stats.total}<span className="text-sm text-zinc-600 font-normal">/100</span></div>
                                        </div>
                                        <div className="text-right">
                                            <div className="text-[10px] text-zinc-500 uppercase">Network Avg</div>
                                            <div className={`text-sm font-mono font-bold ${isAbove ? 'text-green-400' : 'text-red-400'}`}>
                                                {avgNetworkHealth} <span className="text-[10px] bg-white/5 px-1 rounded ml-1">{isAbove ? '+' : ''}{delta}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        {[
                                            { label: 'Uptime', val: stats.breakdown.uptime, avg: globalHealthBreakdown.uptime },
                                            { label: 'Capacity', val: stats.breakdown.capacity, avg: globalHealthBreakdown.capacity },
                                            { label: 'Reputation', val: stats.breakdown.reputation, avg: globalHealthBreakdown.reputation },
                                            { label: 'Version', val: stats.breakdown.version, avg: globalHealthBreakdown.version }
                                        ].map((m) => (
                                            <div key={m.label}>
