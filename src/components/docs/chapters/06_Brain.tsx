    ...
    return (
        <div className="max-w-5xl mx-auto px-6 py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                <div className="p-6 bg-zinc-900/30 border border-zinc-800 rounded-2xl flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-12">
            <div className="flex justify-between items-center relative h-32 px-4 md:px-12 select-none">
                ...
                <div className={`relative z-10 flex flex-col items-center gap-3 transition-all duration-500 ${step >= 2 ? 'opacity-40 grayscale blur-[1px]' : 'opacity-100'}`}>
                    ...
                    <span className="text-[10px] font-bold text-zinc-500 bg-black px-2 py-1 rounded border border-zinc-800 tracking-widest">PRIVATE_RPC</span>
                ...
                <div className={`relative z-10 flex flex-col items-center gap-3 transition-all duration-500 ${step >= 3 ? 'opacity-100 scale-110' : 'opacity-20 scale-90'}`}>
                    ...
                    <span className="text-[10px] font-bold text-zinc-500 bg-black px-2 py-1 rounded border border-zinc-800 tracking-widest">SWARM_RACE</span>
                </div>
            </div>

            <div className="bg-black/80 rounded-xl p-5 font-mono text-[10px] h-36 flex flex-col justify-end border border-zinc-800 relative overflow-hidden shadow-inner">
                <div className="absolute top-2 right-3 text-[8px] text-zinc-700 tracking-widest">ENGINE_LOG_v3.0</div>
