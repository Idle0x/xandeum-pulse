...
export const NodeCard = ({ 
  ...
  const getCycleContent = () => {
    ...
    if (sortBy === 'storage') {
      return { 
        ...
        color: zenMode ? zenTextMain : 'text-purple-400', 
        icon: HardDrive 
      };
    }
    ...
    if (sortBy === 'health') { 
      ...
      return { 
        label: 'Health Score', 
        value: `${score}/100`, 
        color: zenMode ? zenTextMain : (score > 80 ? 'text-green-400' : 'text-yellow-400'), 
        icon: Activity 
      }; 
    }
    ...
    if (sortBy === 'uptime') {
      return { 
        ...
        color: zenMode ? zenTextMain : 'text-orange-400', 
        icon: Zap 
      };
    }
  ...
  // --- ZEN STYLES ---
  // If Zen: pure black, no gradients, flat border. If Normal: gradients, hover scaling.
  ...
  return (
    ...
    >
      {/* Top Right Badge (Hover only in Normal, Always visible or distinct in Zen?) -> Keep hover for cleanliness */}
      {!zenMode && (
        ...
        <div className="overflow-hidden pr-2 w-full">
          <div className="flex items-center gap-1.5 md:gap-2 mb-1">
             ...
             <div className="flex gap-1">
                {/* ZEN BADGES: Monochrome Hierarchy */}
          ...
          <div className="relative h-4 md:h-6 w-full">
             {/* Zen Mode: No hover flip effect for IP/Pubkey. Show generic info or static. keeping flip for data density but removing animation timing if zen */}
      ...
      <div className="space-y-1.5 md:space-y-3">
        <div className="flex justify-between items-center text-[9px] md:text-xs">
          ...
          {/* Zen Highlight: Border instead of Glow */}
        ...
        <div className="pt-1 md:pt-2">
          ...
          {/* Rewards Box: Zen uses dashed borders for alerts, simple borders for standard */}
