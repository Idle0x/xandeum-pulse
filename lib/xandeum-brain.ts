...
async function fetchCredits() {
    // We try to fetch. If it fails (403/404), we catch it and return empty to prevent crash.
    ...
    // Robust parsing: Check for `pods_credits` OR fallback to root array
